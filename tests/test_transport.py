...
def test_only_fixed_operation_specific_requests_can_be_prepared() -> None:
    ...
    assert tuple(
        inspect.signature(_PreparedTransportRequest._for_hpd_initialization).parameters
    ) == (
        "bank",
        "subscriber",
        "protocol",
    ...
    assert tuple(
        inspect.signature(_PreparedTransportRequest._for_hpd_transfer).parameters
    ) == (
        "bank",
        "protocol",
        "transaction_id",
    ...
    assert tuple(
        inspect.signature(_PreparedTransportRequest._for_hpd_receipt).parameters
    ) == (
        "bank",
        "protocol",
        "transaction_id",
    ...
    assert tuple(
        inspect.signature(_PreparedTransportRequest._for_hkd_initialization).parameters
    ) == (
        "bank",
        "subscriber",
        "protocol",
    ...
    assert tuple(
        inspect.signature(_PreparedTransportRequest._for_hkd_transfer).parameters
    ) == (
        "bank",
        "protocol",
        "transaction_id",
    ...
    assert tuple(
        inspect.signature(_PreparedTransportRequest._for_hkd_receipt).parameters
    ) == (
        "bank",
        "protocol",
        "transaction_id",
    ...
    assert tuple(
        inspect.signature(_PreparedTransportRequest._for_htd_initialization).parameters
    ) == (
        "bank",
        "subscriber",
        "protocol",
    ...
    assert tuple(
        inspect.signature(_PreparedTransportRequest._for_htd_transfer).parameters
    ) == (
        "bank",
        "protocol",
        "transaction_id",
    ...
    assert tuple(
        inspect.signature(_PreparedTransportRequest._for_htd_receipt).parameters
    ) == (
        "bank",
        "protocol",
        "transaction_id",
    ...
    assert tuple(
        inspect.signature(_PreparedTransportRequest._for_btd_initialization).parameters
    ) == (
        "bank",
        "subscriber",
        "protocol",
    ...
    assert tuple(
        inspect.signature(_PreparedTransportRequest._for_btd_transfer).parameters
    ) == (
        "bank",
        "protocol",
        "transaction_id",
    ...
    assert tuple(
        inspect.signature(_PreparedTransportRequest._for_btd_receipt).parameters
    ) == (
        "bank",
        "protocol",
        "transaction_id",
    ...
    assert not hasattr(_PreparedTransportRequest, "_for_metadata")
